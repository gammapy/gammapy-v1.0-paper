...
system. PIG are self-contained documents which outline a set of larger
changes to the \gammapy code base. This includes larger feature additions,
code and package restructuring and maitenance as well as changes related
...
coordination committee, which take the final decision on the
...
follows the nornal PIG guidelines. Typically roadmaps are written
