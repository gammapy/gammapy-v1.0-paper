...
\begin{figure*}[t]
	\centering
	\includegraphics[width=1.\textwidth]{static/gammapy-fermi-ts-image}
	\caption{
		Gammapy application example: A \textit{Fermi} survey TS map of the inner
		Galactic plane region. } \label{fig:fermi-ts-image} \end{figure*}
...
\begin{figure*}[t]
	...
	\label{fig:data-model} \end{figure*}
