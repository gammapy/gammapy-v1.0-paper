...
treatment. In fields of view containing several overlapping sources, the 1D
...
MapDataset (see Sections~\ref{ssec:gammapy-makers,ssec:gammapy-datasets}).
...
contribution from each of the three source models. This can be seen in the left
