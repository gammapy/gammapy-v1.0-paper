...
For the “minuit” backend see https://iminuit.readthedocs.io/en/latest/reference.html for a detailed description of the available options.
...
For the “sherpa” backend you can choose the optimization algorithm between “simplex”, “levmar”, “moncar”, “gridsearch”.
Those methods are described and compared on \url{http://cxc.cfa.harvard.edu/sherpa/methods/index.html}. The available options of the optimization methods are further described on the following page\url{https://cxc.cfa.harvard.edu/sherpa/methods/opt_methods.html}.
...
%the sampling code should be moved to the recipe (for now it is imported) because it have been removed from the core package.
