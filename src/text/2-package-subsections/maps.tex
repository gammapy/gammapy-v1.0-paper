...
\todo{Include example of a sky-map? Perhaps also a region map? Although maybe too much.}

\todo{Code examples of what? Making a geom and filling a map? Transforming coordinates? 3D maps? Would be good to have the code example and the plot be related}
