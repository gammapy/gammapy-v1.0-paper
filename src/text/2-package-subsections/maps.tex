...
The \verb|gammapy.maps| sub-package provides classes for representing data
...
The geometry defines the pixelization scheme and map boundaries. It also
...
\begin{itemize}
	\item \textbf{WCS: } The FITS WCS pixelization supports a different
	      ...
	      pixelization scheme. \item \textbf{HEALPix: } This pixelization provides a
	      ...
	      maps, relying in some cases on projections to a local WCS grid. \item
	      \textbf{Region geometries: } In this case, instead of a fine spatial grid
