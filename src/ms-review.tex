...
the class name.
The spectral models include a special class of normed models, named using the NormSpectralModel suffix.
normalisation. These spectral models feature a dimension-less norm parameter
instead of a physical amplitude parameter. They
