...
\begin{figure*}[t]
	...
	\caption{
		...
		and \fermi instruments. The \cta IRFs are from the \textit{prod5} production for the {\it alpha} configuration of the south array. The \hess IRFs are from the DL3 DR1,
