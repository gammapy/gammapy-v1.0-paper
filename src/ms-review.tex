...
inside the corresponding region. Technically the region is represented on the local
tangential projection, as implement by \cite{AstropyRegions2022}.
...
selecting a region of $X^{\circ}$ around the
