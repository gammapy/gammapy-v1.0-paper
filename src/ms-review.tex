...
The \gammapy is package an independent community-developed software project, it has been selected to be the core library for the Science Analysis tools of CTAO
...
The increased availability of public data that followed the definition of a common data format, and the development of \gammapy as a community-driven open software, led the way toward a more open science in the very-high-energy \gray Astronomy domain. In future CTAO will be an open observatory committed to follow the FAIR (Findable, Accessible, Interoperable and Reusable) principles \citep{FAIR16, FAIR22} that define the key requirements for open science. 
...
\item $PSF(p|p_{\rm true}, E_{\rm true})$ is the point spread function (PSF). It gives the probability of
  ...
  \gammaray instruments consider $PSF(\delta p|p_{\rm true}, E_{\rm true})$, the probability density of the angular separation between true and reconstructed directions,
  $\delta p = p_{\rm true} - p$.
\item $E_{\rm disp}(E|p_{\rm true}, E_{\rm true})$ is the energy dispersion. It gives the probability to
  ...
  \gammaray instruments consider $E_{\rm disp}(\mu|p_{\rm true}, E_{\rm true})$, the probability density of the migration, $\mu=\frac{E}{E_{\rm true}}$.
\end{itemize}
...
\SI{0.5}{TeV}~to~{1.5}{TeV} and \SI{1.5}{TeV}~to~{20}{TeV} respectively.
%
\begin{figure*}[t]
    \sidecaption
	...
	\caption{
        ...
        PKS~2155-304 in two energy bands (\SI{0.5}{TeV}~to~{1.5}{TeV} and \SI{1.5}{TeV}~to~{20}{TeV})
...
microwave background (CMB). We adopt the prescription on the target
