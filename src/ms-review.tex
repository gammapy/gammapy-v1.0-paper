...
system. %% where? in the data units of a FITS file.
...
%% CN: I don't understand this: since the high-level methods are the same, then they "imply"
%% joint analyses?? Maybe they eventually allow or permit?
...
%% CN: well models represent the analytical description of the source morphology
%% and spectra we gave in the first equation, right? I don't understand why we
%% talk of catalogues here.
...
%% otherwise what's teh point of the `print`' functions?
\begin{figure}
	\small
...
%
%
%% CN: description of the HAWC IRF missing, what is the difference between the gray
%% and black effective areas? Where are they taken from?
...
%% CN: I don't understand what "the latter" refers to.
...
methods.
%% CN: references missing for Cash and Wstat statistics
%% CN: what are the "corresponding on off versions"?
