...
\subsection{Events and Instrument Response Functions: the Data Level 3}

\gammaray data at the Data Level 3 (DL3) consists in lists of gamma-like events and their
...
An additional component of DL3 IRFs is the residual hadronic background model $$.
...
\begin{align}
N(p, E) {\rm d}p {\rm d}E =  E_{\rm disp} \star (PSF \star A_{\rm eff} t_{\rm obs} t_{\rm obs}) + Bkg(p, E)
\end{align}
