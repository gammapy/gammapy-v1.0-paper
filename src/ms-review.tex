...
VHE \gammaray astronomy covers the energy range from few tens of \unit{GeV} up to the \unit{PeV}.
...
\begin{equation}
    \Phi(p_{\rm true}, E_{\rm true}; \hat{\theta}), [\Phi] = \unit{TeV^{-1}.cm^{-2}.s^{-1}}
...
components within the same source. To handle lists of multiple \code{SkyModel} objects, \gammapy
...
\begin{table*}
    \begin{center}
        \begin{tabular}{lll}
         ...
         \hline
         dnde & Differential flux at a given energy & \unit{TeV^{-1}.cm^{-2}.s^{-1}} \\
         e2dnde & Differential flux at a given energy  & \unit{TeV.cm^{-2}.s^{-1}} \\
         flux & Integrated flux in a given energy range & \unit{cm^{-2}.s^{-1}} \\
         eflux & Integrated energy flux in a given energy range & \unit{erg.cm^{-2}.s^{-1}}\\
         \hline
        \end{tabular}
    \end{center}
...
\qtyrange{0.5}{1.5}{TeV} and \qtyrange{1.5}{20}{TeV} respectively.
%
\begin{figure*}[t]
    \sidecaption
	...
	\caption{
        ...
        PKS~2155-304 in two energy bands (\qtyrange{0.5}{1.5}{TeV} and \qtyrange{1.5}{20}{TeV})
...
catalog (7 years of data with energy from \qty{10}{GeV} to \qty{2}{TeV},
~\citealt{3FHL}).
...
range spans \qty{80}{GeV} to \qty{20}{TeV}. The data reduction for the 1D analysis
...
with $2.5\,{\rm years}$ of data and span an energy range \qty{300}{GeV} to \qty{300}{TeV}.
...
parabola is fitted to the almost five decades in energy \qty{10}{GeV} to \qty{300}{TeV}.
