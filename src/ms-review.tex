...
\abstract
    ...
    This necessity prompted the development of open, high-level, astronomical software customised for high-energy astrophysics.
	}
	{
...
%% Context
%% CN: I think Fermi-LAT data were available from the 2nd year on
%% https://fermi.gsfc.nasa.gov/ssc/data/policy/
...
% CN: last-minute transition improvement
...
%% CN: I don't see the parallel between gamma-ray astronomy establishing itself and the success of python
%% maybe this was the introduction of the very first draft?
%% I would just write: "In the past decade, \textit{Python} has become..."
...
%% CN: astronomy alone not a sub-field
...
%% CN: what's this??? Out of place here! %%%%
%They consist of two
...
%% CN: I would remark this also demonstrated Gammapy could be applied to WCD
%% depite having been designed for IACTs initially
...
the \gammapy sub-packages\footnote[number]{\url{https://docs.gammapy.org/1.0/user-guide/package.html}}.
...
\footnote{\url{https://docs.gammapy.org/1.0.1/user-guide/datasets/index.html#datasets}}.
...
The model gallery\footnote[number]{\url{https://docs.gammapy.org/1.0/user-guide/model-gallery/index.html}}
...
in the online documentation\footnote[number]{\url{https://docs.gammapy.org/1.0/tutorials/api/models.html#implementing-a-custom-model}}.
...
partly involve \gammpy are available in the online documentation of the
Agnpy, Naima, Jetset and Gamera packages\footnote{\url{https://agnpy.readthedocs.io/en/latest/tutorials/ssc_gammapy_fit.html}},
\footnote{\url{https://naima.readthedocs.io/en/stable/tutorial.html}}, 
\footnote{\url{https://jetset.readthedocs.io/en/stable/user_guide/documentation_notebooks/gammapy_plugin/gammapy_plugin.html}},
\footnote{\url{http://libgamera.github.io/GAMERA/docs/fitting_data.html}}.
...
\begin{itemize}
	...
	\code{TSMapEstimator} respectively. For this \gammapy provides a simple \code{find_peaks}
