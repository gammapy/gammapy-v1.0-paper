...
\abstract{
	...
	To facilitate the rejection of the hadronic background, several techniques for background estimation
	...
	The flexibility and power of the software is displayed in a final multi-instrument example,
